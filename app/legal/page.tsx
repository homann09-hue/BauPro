    ...
    <main className="min-h-screen bg-fog px-4 py-8">
      <div className="mx-auto max-w-5xl">
        ...
        <div className="mt-5 rounded-lg bg-ink p-5 text-white shadow-lift">
          ...
          <h1 className="text-3xl font-black">Rechtliche Informationen</h1>
          <p className="mt-2 max-w-2xl text-sm leading-6 text-white/75">
            Diese Seiten bündeln Datenschutz, Anbieterkennzeichnung, AGB, AVV und Aufbewahrungskonzept als prüfpflichtige Entwürfe.
            Sie ersetzen keine anwaltliche Prüfung, sind aber bewusst transparent statt versteckt.
          </p>
        </div>
