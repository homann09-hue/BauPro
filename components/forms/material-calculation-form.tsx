    ...
    <form action={createMaterialCalculationAction} className="surface p-4 sm:p-5">
      ...
      <div className="mb-4 flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-slate-500">Schnelle Vor-Kalkulation mit automatischem Zuschlag.</p>
        </div>
      </div>
      ...
      <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <label className="sm:col-span-2 lg:col-span-3">
          ...
          <input className="field-input" name="notes" placeholder="z. B. grobe Vorkalkulation, Bestand pruefen" />
        </label>
      </div>
